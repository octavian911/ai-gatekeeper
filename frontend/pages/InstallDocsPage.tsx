      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="space-y-8">
          <section className="bg-card border rounded-lg p-6">
            <h2 className="text-2xl font-bold mb-4">1. Run Locally First</h2>
            <p className="text-foreground mb-4">
              Test AI Gatekeeper against your running application to ensure everything works correctly:
            </p>
            <div className="bg-muted border rounded-lg p-4 relative">
              ...
              >
                {copiedCommand ? <Check className="w-4 h-4 text-green-600 dark:text-green-400" /> : <Copy className="w-4 h-4" />}
              </button>
            </div>
            <p className="text-muted-foreground text-sm mt-3">
              Replace <code className="bg-muted px-2 py-1 rounded">http://localhost:3000</code> with your application's URL.
            </p>
          </section>

          <section className="bg-card border rounded-lg p-6">
            <h2 className="text-2xl font-bold mb-4">2. Create Baseline Screenshots</h2>
            <p className="text-foreground mb-4">
  ...
  "baselines": [
    ...
    },
    {
      ...
      "hash": "def456..."
          ...
          <section className="bg-card border rounded-lg p-6">
            <h2 className="text-2xl font-bold mb-4">3. Add GitHub Actions Workflow</h2>
            <p className="text-foreground mb-4">
              Create <code className="bg-muted px-2 py-1 rounded">.github/workflows/ai-gate.yml</code> in your repository:
            </p>
            <div className="bg-muted border rounded-lg p-4 relative max-h-96 overflow-y-auto">
              <pre className="text-sm text-foreground">
              ...
              >
                {copiedWorkflow ? <Check className="w-4 h-4 text-green-600 dark:text-green-400" /> : <Copy className="w-4 h-4" />}
              </button>
            </div>
            <p className="text-muted-foreground text-sm mt-3">
          ...
          <section className="bg-card border rounded-lg p-6">
            <h2 className="text-2xl font-bold mb-4">4. Use the Template Repo</h2>
            <p className="text-foreground mb-4">
...
└── scripts/
    └── run-visual-test.sh`}
            ...
            <ol className="list-decimal list-inside text-foreground space-y-2 ml-4">
              ...
              <li>Update <code className="bg-muted px-2 py-1 rounded">ai-gate.config.json</code> with your routes</li>
