...
```bash
git remote add encore encore://ai-output-gate-s8k2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/ai-output-gate-s8k2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/ai-output-gate-s8k2/settings/integrations/github)
